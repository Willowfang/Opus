...
namespace Opus.Common.Implementation.Data.Composition
{
    ...
    public class CompositionFile : CompositionSegment, ICompositionFile
    {
        ...
        public override string? DisplayName
        {
            get
            {
                return MinCount == 0 && SegmentName != null
                    ? $"({SegmentName})"
                    : SegmentName;
            }
        }
        ...
        #region Methods
        /// <summary>
        /// Evaluate a file against the search expression, ignoring the ignore expression.
        /// </summary>
